...
public class StatesLookup: MonoBehaviour {
	...
	void Awake() {
		...
		pos.Add ("MT", new Vector3 (4.31f, y, -4.12f));
		pos.Add ("NE", new Vector3 (1.14f, y, -1.41f));
		pos.Add ("NV", new Vector3 (6.97f, y, -0.95f));
		pos.Add ("NH", new Vector3 (-8.06f, y, -3.23f));
		pos.Add ("NJ", new Vector3 (-7.54f, y, -1.59f));
		pos.Add ("NM", new Vector3 (3.6f, y, 1.64f));
		pos.Add ("NY", new Vector3 (-6.87f, y, -2.97f));
		pos.Add ("NC", new Vector3 (-6.68f, y, 0.69f));
		pos.Add ("ND", new Vector3 (1.1f, y, -4.12f));
		pos.Add ("OH", new Vector3 (-4.6f, y, -1.17f));
		pos.Add ("OK", new Vector3 (0.56f, y, 1.33f));
		pos.Add ("OR", new Vector3 (7.87f, y, -3.49f));
		pos.Add ("PA", new Vector3 (-6.27f, y, -1.75f));
		pos.Add ("RI", new Vector3 (-8.35f, y, -2.54f));
